  ...
  TESTLOG ("lstData.nGlobalIdentifier is set as %d \n", stData.nGlobalIdentifier); 
   ...
   switch(stData.nMessageCode)
   {
          case (long long)CMESSAGE_CODE_ACTIONS::MESSAGE_CODE_ACTIONS_REGISTER:
            {
               //pthread_mutex_lock(&g_ConsoleIOMutex);
               cout << "enum class CMESSAGE_CODE_ACTIONS : long \
{ \n\
...
*/
                      ...
                      cin >> stData.nGlobalIdentifier;
                      cout << "enter For or to Server flg i" << endl;
                      cin >> stData.nFrOrToServerFlg;
                      cout << "enter MessageCode i" << endl;
                      ...
                      cin >> stData.bFinalResponse;
                      cout << "enter LatestClntSeqNo i" << endl;
                      cin >> stData.nLatestClntSeqNo;
                      cout << "enter nSession i" << endl;
                      cin >> stData.nSessionId;
                      //cin >> stData.nCommand;
                      //pthread_mutex_unlock(&g_ConsoleIOMutex);
